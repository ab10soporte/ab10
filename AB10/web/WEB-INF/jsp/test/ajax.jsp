...
<html>
    <head>                        
        ...
        -->
        <link rel="stylesheet" href="<c:url value="/resource/libs/adminlte-1.0.0/skins/skin-blue.min.css"/>" />
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
                        ...
                        <ul class="nav navbar-nav">
                                        ...
                                        <ul class="menu">
                                            <li><!-- start message -->
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <!-- User Image -->
                                                        <img src="<c:url value="/resource/image/adminlte/user2-160x160.jpg" />" class="img-circle" alt="User Image">
                                                    </div>
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            <li><!-- start notification -->
                                                <a href="#">
                                                    <i class="fa fa-users text-aqua"></i> 5 personas logeadas
                                                </a>
                                            </li>
                                            <!-- end notification -->
                                        </ul>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <img src="<c:url value="/resource/image/adminlte/user2-160x160.jpg" />" class="user-image" alt="User Image">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><a href="paciente.htm"><i class="fa fa-link"></i> <span>Pacientes</span></a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="#">TrailMaking Test</a></li>
                                        <li><a href="#">WAIS III</a></li>
                                    </ul>
                                </li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div id="contentDiv">Pulsa 'ACE' y este texto se actualizará</div>
                    <!-- Comienzo formularios de prueba-->
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2016 <a href="#">AB10</a>.</strong> Todos los derechos reservados.
            </footer>
        ...
        <!-- AdminLTE App -->        
        <script src="<c:url value="/resource/libs/adminlte-1.0.0/js/app.min.js" />"></script>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#ACE").click(function (e) {
                    e.preventDefault();
                    $("#contentDiv").html('<p>holaaaaaaaaa</p>');
                });
           });
