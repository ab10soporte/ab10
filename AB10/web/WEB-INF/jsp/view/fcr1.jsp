                    ...
                    <div class="panel-group" id="accordion">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse4" class="panel-collapse collapse">
                                ...
                                <!--Memoria no verbal a largo plazo-->
                                <div class=" panel panel-info">
                                    <div class="panel-heading">Memoria no verbal a largo plazo</div>
                                    <div class="panel-body">
                                        <table class="table table-bordered" >
                                            <tbody>
                                            <p><strong>Escala 1:</strong> Favor de tomar el tiempo que le lleva al evaluado completar la imagen</p>
                                        ...
                                        <table class="table table-bordered" >
                                            <p><strong>Escala 2:</strong> Después de 20 minutos se le da al sujeto una nueva hoja y un lápiz y se le pide que ejecute nuevamente el dibujo de memoria; <strong>Se toma el tiempo como la veces anteriores</strong> y se anota si el segundo proceso gráfico es parecido o no al primero.</p>
                                            <p>Por favor, registre la puntuación de cada uno de los ítems de la copia en la grilla 2</p>  
                                            <tbody>
                                                <tr class="row0">
                                                    <td class="column0 style1 s"><strong>Grilla 2</strong></td>
                                                    <td class="column1 style7 s style8" colspan="5"><strong>Puntuación por cada Unidad</strong></td>
                                                </tr>
                                                <tr class="row1">
                                                    <td class="column0 style10 s style11" rowspan="4">Numero de Unidad</td>
                                                ...
                                                <tr class="row4"></tr>
                                                <tr class="row5">
                                                    <td class="column0 style5 e2n">1</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r1e2n" id="r1e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r1e2n" id="r1e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r1e2n" id="r1e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r1e2n" id="r1e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r1e2n" id="r1e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row6">
                                                    <td class="column0 style5 e2n">2</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r2e2n" id="r2e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r2e2n" id="r2e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r2e2n" id="r2e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r2e2n" id="r2e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r2e2n" id="r2e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row7">
                                                    <td class="column0 style5 e2n">3</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r3e2n" id="r3e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r3e2n" id="r3e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r3e2n" id="r3e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r3e2n" id="r3e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r3e2n" id="r3e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row8">
                                                    <td class="column0 style5 e2n">4</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r4e2n" id="r4e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r4e2n" id="r4e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r4e2n" id="r4e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r4e2n" id="r4e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r4e2n" id="r4e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row9">
                                                    <td class="column0 style5 e2n">5</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r5e2n" id="r5e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r5e2n" id="r5e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r5e2n" id="r5e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r5e2n" id="r5e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r5e2n" id="r5e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row10">
                                                    <td class="column0 style5 e2n">6</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r6e2n" id="r6e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r6e2n" id="r6e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r6e2n" id="r6e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r6e2n" id="r6e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r6e2n" id="r6e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row11">
                                                    <td class="column0 style5 e2n">7</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r7e2n" id="r7e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r7e2n" id="r7e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r7e2n" id="r7e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r7e2n" id="r7e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r7e2n" id="r7e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row12">
                                                    <td class="column0 style5 e2n">8</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r8e2n" id="r8e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r8e2n" id="r8e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r8e2n" id="r8e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r8e2n" id="r8e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r8e2n" id="r8e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row13">
                                                    <td class="column0 style5 e2n">9</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r9e2n" id="r9e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r9e2n" id="r9e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r9e2n" id="r9e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r9e2n" id="r9e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r9e2n" id="r9e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row14">
                                                    <td class="column0 style5 e2n">10</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r10e2n" id="r10e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r10e2n" id="r10e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r10e2n" id="r10e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r10e2n" id="r10e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r10e2n" id="r10e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row15">
                                                    <td class="column0 style5 e2n">11</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r11e2n" id="r11e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r11e2n" id="r11e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r11e2n" id="r11e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r11e2n" id="r11e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r11e2n" id="r11e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row16">
                                                    <td class="column0 style5 e2n">12</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r12e2n" id="r12e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r12e2n" id="r12e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r12e2n" id="r12e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r12e2n" id="r12e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r12e2n" id="r12e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row17">
                                                    <td class="column0 style5 e2n">13</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r13e2n" id="r13e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r13e2n" id="r13e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r13e2n" id="r13e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r13e2n" id="r13e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r13e2n" id="r13e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row18">
                                                    <td class="column0 style5 e2n">14</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r14e2n" id="r14e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r14e2n" id="r14e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r14e2n" id="r14e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r14e2n" id="r14e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r14e2n" id="r14e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row19">
                                                    <td class="column0 style5 e2n">15</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r15e2n" id="r15e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r15e2n" id="r15e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r15e2n" id="r15e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r15e2n" id="r15e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r15e2n" id="r15e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row20">
                                                    <td class="column0 style5 e2n">16</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r16e2n" id="r16e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r16e2n" id="r16e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r16e2n" id="r16e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r16e2n" id="r16e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r16e2n" id="r16e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row21">
                                                    <td class="column0 style5 e2n">17</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r17e2n" id="r17e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r17e2n" id="r17e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r17e2n" id="r17e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r17e2n" id="r17e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r17e2n" id="r17e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row22">
                                                    <td class="column0 style5 e2n">18</td>
                                                    <td align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r18e2n" id="r18e2op1" value="2">
                                                        </div>
                                                    </td>
                                                    <td class="column2 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r18e2n" id="r18e2op2" value="1">
                                                        </div>
                                                    </td>
                                                    <td class="column3 style2 null" align="center">
                                                        <div class="radio">
                                                            <div class="radio">
                                                                <input type="radio" name="r18e2n" id="r18e2op3" value="1">
                                                            </div>
                                                    </td>
                                                    <td class="column4 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r18e2n" id="r18e2op4" value="3"> <!-- Si es 3 equivale a medio punto-->
                                                        </div>
                                                    </td>
                                                    <td class="column5 style2 null" align="center">
                                                        <div class="radio">
                                                            <input type="radio" name="r18e2n" id="r18e2op5" value="0" checked>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="row23">
