            ...
            <div class="content-wrapper ">                            
                ...
                <section class="content">                    
                    ...
                    <div class="panel-group" id="accordion">
                            ...
                            <div id="collapse4" class="panel-collapse collapse">
                                <form action="tmta.htm" method="post">
                                    ...
                                    <div class=" panel panel-info">
                                        <div class="panel-heading">Ejercicio B</div>
                                        <div class="panel-body">
                                            <table class="table table-bordered" >
                                                <tbody>
                                                <p><strong>Ensayo B:</strong> Guarda cierta semejanza formal con la forma A, pero con una diferencia en la demanda cognitiva.</p>
                                                <p>Hay números (del 1 al 4) y letras (de A a D), distribuidos al azar.</p>
                                                <p>El sujeto debe unir los estímulos alternando números y letras, respetando el orden numérico ascendente y alfabético.</p>                                 
                                                <tr>
                                                ...
                                                <tr>
                                                    <td align="left" valing="middle">
                                                        <img src="<c:url value="/resource/image/helpdoc/tmta3.jpg" />" class="img-responsive" alt="tmta1"> 
                                                    </td>
                                                    <td>                                                                  
                                                        ...
                                                        <!--                                                    <div class="form-check form-check-inline">
                                                                                                                ...
                                                                                                                <textarea class="form-control" id="cro3ob" rows="2"></textarea>
                                                                                                            </div>-->
                                                    </td>
                                                </tr>     
                                    ...
                                    <br/>
                                    <div class=" panel panel-info">
                                        <div class="panel-heading">Prueba B</div>
                                        <div class="panel-body">
                                            <table class="table table-bordered" >
                                                <tbody>
                                                <p><strong>Prueba B:</strong> Guarda cierta semejanza formal con la forma A, pero con una diferencia en la demanda cognitiva.</p>
                                                <p>Hay números (del 1 al 13) y letras (de A a L), distribuidos al azar.</p>
                                                <p>El sujeto debe unir los estímulos alternando números y letras, respetando el orden numérico ascendente y alfabético.</p>                                 
                                                <tr>
                                                    <td align="center" bgcolor="#EFECEC">Imagen</td>
                                                ...
                                                <tr>
                                                    <td align="left" valing="middle">
                                                        <img src="<c:url value="/resource/image/helpdoc/tmta4.jpg" />" class="img-responsive" alt="tmta1"> 
                                                    </td>
                                                    <td>                                                                  
                                                        <div class="form-check-inline pull-right">
                                                        ...
                                                        <!--                                                    <div class="form-check form-check-inline">
                                                                                                                <label for="ori1">Observacion</label>
                                                                                                                <textarea class="form-control" id="cro4ob" rows="2"></textarea>
                                                                                                            </div>-->
                                                    </td>
                                                </tr>     
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>                                                    
                                                    <div class="panel-body">
                                                        <div class="radio">
                                                            <label><input type="radio" name="ocu" value="1" checked>Empleado u oficio calificado (incluye tareas de secretaría, tareas administrativas, etc.)</label>
                                                        </div>
                                                        <div class="radio">
                                                            <label><input type="radio" name="ocu" value="2">Empleado no calificado (incluye ama de casa, trabajo rural, albañil, etc.)</label>
                                                        </div>
                                                        <div class="radio">
                                                            <label><input type="radio" name="ocu" value="3">Profesional u estudiante de nivel secundario o superior</label>
                                                        </div>
                                                    </div>
                                                </td>                                               
                                            </tr> 
                                            <tr>
                                                <td>Ensayo B</td>
                                                <td align="right"><input type="number" id="idensayob" name="ensayob" min="0" max="50" class="form-control" value="0" style="text-align:center; width:100px;"></td>                                                                                   
                                                <td>Prueba B</td>
                                                <td align="right"><input type="number" id="idpruebab" name="pruebab" min="0" max="50" class="form-control" value="0" style="text-align:center; width:100px;"></td>                                                                                   
                                            </tr> 
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <form action="tmtb.htm" method=post name="callSave">
                            <input type="hidden" name="action" value="1">
                            <input type="hidden" name="userid" value="${requestScope.userid}">

                            <input type="hidden" name="legajo" id="idlegajo">                                        
                            <input type="hidden" name="ealc" id="idealc">
                            <input type="hidden" name="ocup" id="idocup">
                            <input type="hidden" name="ensb" id="idensb">
                            <input type="hidden" name="prub" id="idprub">
                        </form>
                    </div>
                </section>
        ...
        <script>
            ...
            $('#idbtnsave').click(function () {
                if ($(this).hasClass('disabled')) {
                    ...
                    $("input[name='ocu']").each(function () {
                        if (this.checked) {
                            $("#idocup").val(this.value);
                        }
                    });
                    $("#idensb").val($("#idensayob").val());
                    $("#idprub").val($("#idpruebab").val());
