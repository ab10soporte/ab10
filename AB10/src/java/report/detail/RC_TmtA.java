 ...
 * @author Seba
 */
public class RC_TmtA implements RP_Interface {
    ...
    public void generateData() {
        ...
        TmtADao tmtaDao = new TmtADao();
        TmtA tmta = tmtaDao.getTmtAByLegajo(legajo);
        ealc = tmta.getEalc(); // Busco el valor de educacion alcanzado.

        // Aplico las tranformaciones.
        columPB = parcePB(tmta);
    ...
    public String getTextDetail() {
        ...
        try {
            String tmp = "";
            // prub
            tmp = getTextoDetalle(columZ.get("prua"));
            result = result.replaceAll("prua", tmp);
...
*/
    ...
    private Map<String, Float> calcularZ(Map<String, Integer> tablePB, Map<String, Float> tableMedia, Map<String, Float> tableDT) {
        ...
        try {
            ...
            result.put("prua", ((tablePB.get("prua") - tableMedia.get("prua")) / tableDT.get("prua")));            
        } catch (Exception e) {
            result = null;
        }
